...
sceneRegexList = {
    ...
    '"Asset":"NPC"': '"Asset":"Character"',
    ',"NPC",': ',"Character",',
    '"characterEditorDataJson":"{\\"realData\\":\\"\\[\\\\{\\\\\\\\\\\\"apiName\\\\\\\\\\\\":\\\\\\\\\\\\"changeCharacter\\\\\\\\\\\\",\\\\\\\\\\\\"value\\\\\\\\\\\\":\\\\\\\\\\\\"(\\\\\\\\\\\\w+)\\\\\\\\\\\\",\\\\\\\\\\\\"saveFileType\\\\\\\\\\\\":\\\\\\\\\\\\"(\\\\\\\\\\\\w+)\\\\\\\\\\\\"}\\\\\\\\\\",\\\\\\\\\\\\"apiName\\\\\\\\\\\\":\\\\\\\\\\\\"trunksetMesh\\\\\\\\\\\\",\\\\\\\\\\\\"value\\\\\\\\\\\\":\\\\\\\\\\\\"(\\\\\\\\\\\\d+)\\\\\\\\\\\\",\\\\\\\\\\\\"saveFileType\\\\\\\\\\\\":\\\\\\\\\\\\"(\\\\\\\\\\\\w+)\\\\\\\\\\\\"}]\\\\\\",\\\\\\\\\\\\"characterType\\\\\\\\\\\\":\\\\\\\\\\\\"(\\\\\\\\\\\\w+)\\\\\\\\\\\\"}\\\\\\",\\\\\\\\\\\\"basicStance\\\\\\\\\\\\":\\\\\\\\\\\\"(\\\\\\\\\\\\d+)\\\\\\\\\\\\"}\\\\\\",\\\\\\\\\\\\"version\\\\\\\\\\\\":\\\\\\\\\\\\"2.1\\\\\\\\\\\\"}"':
